srcdir = /home/odroid/projects/PHPJS
builddir = /home/odroid/projects/PHPJS
top_srcdir = /home/odroid/projects/PHPJS
top_builddir = /home/odroid/projects/PHPJS
EGREP = /bin/grep -E
SED = /bin/sed
CONFIGURE_COMMAND = './configure' '--enable-phpjs'
CONFIGURE_OPTIONS = '--enable-phpjs'
SHLIB_SUFFIX_NAME = so
SHLIB_DL_SUFFIX_NAME = so
ZEND_EXT_TYPE = zend_extension
RE2C = re2c
AWK = gawk
shared_objects_phpjs = phpjs.lo duktape.lo interface.lo functions.lo objects.lo wrapper.lo
PHP_PECL_EXTENSION = phpjs
PHP_MODULES = $(phplibdir)/phpjs.la
PHP_ZEND_EX =
...
prefix = /usr
phplibdir = /home/odroid/projects/PHPJS/modules
